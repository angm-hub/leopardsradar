var N=Object.defineProperty;var L=(t,e,o)=>e in t?N(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o;var a=(t,e,o)=>L(t,typeof e!="symbol"?e+"":e,o);import{r as d,j as B,x as k}from"./index-CrOsZAgu.js";const Y=`#version 300 es
...
}`;function _(){const t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function j(t){const e=(visualViewport==null?void 0:visualViewport.scale)??1,o=(visualViewport==null?void 0:visualViewport.width)??window.innerWidth,i=window.innerWidth-t.documentElement.clientWidth,c=e*o+i,s=outerWidth/c,r=Math.round(100*s);return r%5===0?r/100:r===33?1/3:r===67?2/3:r===133?4/3:s}const Z={fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},X={none:0,contain:1,cover:2},q=`
...
`,G={maxColorCount:7},oe=`#version 300 es
