var P=Object.defineProperty;var H=(t,e,i)=>e in t?P(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i;var a=(t,e,i)=>H(t,typeof e!="symbol"?e+"":e,i);import{r as m,j as w,w as y,ah as z}from"./index-DsoktGS7.js";const N=`#version 300 es
...
}`;function O(){const t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function J(t){const e=(visualViewport==null?void 0:visualViewport.scale)??1,i=(visualViewport==null?void 0:visualViewport.width)??window.innerWidth,o=window.innerWidth-t.documentElement.clientWidth,A=e*i+o,s=outerWidth/A,r=Math.round(100*s);return r%5===0?r/100:r===33?1/3:r===67?2/3:r===133?4/3:s}const K={fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},Z={none:0,contain:1,cover:2},_=`
