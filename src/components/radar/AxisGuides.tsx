  ...
  return (
    <>
      ...
      <div className="pointer-events-none absolute left-1.5 top-1/2 -translate-y-1/2 z-[2] flex flex-col items-center gap-1.5">
        <span
          className="rounded-sm bg-background/60 backdrop-blur-sm px-1.5 py-0.5 text-xs md:text-[9px] font-mono uppercase tracking-[0.2em] text-foreground/55"
          style={{ writingMode: "vertical-rl", transform: "rotate(180deg)" }}
        >
          Jeune
        </span>
        <span
          className="rounded-sm bg-background/40 px-1 py-0.5 text-xs md:text-[10px] text-foreground/35"
          style={{ writingMode: "vertical-rl", transform: "rotate(180deg)" }}
          aria-hidden
        >
          ↑
